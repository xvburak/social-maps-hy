...
<div on:click={()=> (show = !show)} bind:this={menu}
    class="shadow-xl cursor-pointer rounded-[2.5rem] menu p-4 bg-white text-m space-x-4 items-start justify-start flex fixed top-4 md:top-8 left-4 md:left-8 z-50"
